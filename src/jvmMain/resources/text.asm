...
LUCKY_CACHE:
	...
	db " +2 BRICKS,",NEW_LINE," +2 GEMS,",NEW_LINE,NEW_LINE,SPACE_4,"PLAY AGAIN.",END
FRIENDLY_TERRAIN:
	db "FRIENDLY TERRAIN",NEW_LINE
	db " ",NEW_LINE,NEW_LINE,"+1 WALL.",NEW_LINE,SPACE_4,"PLAY AGAIN.",END
MINERS:
	db "MINERS",NEW_LINE
	db "",NEW_LINE,NEW_LINE,NEW_LINE,SPACE_2," +1 QUARRY.",END
MOTHER_LODE:
...
INNOVATIONS:
	...
	db "",NEW_LINE,SPACE_4," +1 TO",NEW_LINE,SPACE_2,"ALL PLAYER'S",NEW_LINE,SPACE_4," QUARRYS,",NEW_LINE,NEW_LINE,"YOU GAIN 4 GEMS.",END
FOUNDATIONS:
...
ELVEN_SCOUT:
	...
	db "DRAW 1 CARD.",NEW_LINE,"DISCARD 1 CARD.",NEW_LINE,"PLAY AGAIN",END
LODESTONE:
	db "LODESTONE",NEW_LINE
	db "+3 TOWER.",NEW_LINE,"THIS CARD CAN'T",NEW_LINE,"BE DISCARDED",NEW_LINE,"WITHOUT PLAYING",NEW_LINE,"IT",END
FLOOD_WATER:
	db "FLOOD WATER",NEW_LINE
	db "PLAYER(S)",NEW_LINE,"W/ LOWEST WALL",NEW_LINE,"ARE -1 DUNGEON",NEW_LINE,"AND 2 DAMAGE TO",NEW_LINE,"TOWER",END
	endmodule